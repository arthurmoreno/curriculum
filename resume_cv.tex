...
\name{Arthur R.}{Moreno}
\address{Rua Sebastião Alves 74, Apt. 104, Tamarineira, Recife, Pernambuco, CEP 52060-100, Brazil}
\mobile{(+81) 99991-8327}

\email{morenorarthur@gmail.com}
%\homepage{www.posquit0.com}
\github{arthurmoreno}
\linkedin{arthur-moreno-154236103}
%\skype{skypeid}
...
\position{Computer Engineer{\enskip\cdotp\enskip}Data Engineer} % Your expertise/fields
\quote{``if the doors of perception were cleansed everything would appear to man as it is infinite."} % A quote or statement

\makecvfooter{\today}{Arthur R. Moreno~~~·~~~Résumé}{\thepage} % Specify the letter footer with 3 arguments: (<left>, <center>, <right>), leave any of these blank if they are not needed
